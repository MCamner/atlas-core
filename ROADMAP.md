...
- [ ] **Frågespecifik kontroll utöver relevans.** Grinden i ruta tre prövar vilken källa ett avgjort påstående handlar om. Den prövar inte om påståendet bär på frågan.
  - **Klart när:** för minst ett ämne finns en deklarerad, deterministisk uppsättning predikat som *besvarar* ämnets fråga, och ett verifierat påstående utanför den uppsättningen uppfyller inte kriteriet. Prövat med två körningar mot samma fil: `PASSWORD=admin` i `settings.env` uppfyller, `TIMEOUT=30` i samma fil gör det inte. Båda verifierade, båda om rätt källa.
