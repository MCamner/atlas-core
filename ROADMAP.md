...
- [ ] Välj ett litet, fast fixture-repo med kända defekter och ett utan defekter. Mät precision mot facit, andel evidensbelagda findings, falskt positiva, iterationsantal, kostnad och stopporsak.
  ...
  - **Mätt från noll observationer**, inte bara från en förladdad bas. Två rader börjar med snapshoten och ingenting läst: planen avgränsar, hosten löser upp mönstren, och defekten fastställs mot de bytes läsningen gav. De förladdade raderna hoppar över den halva av loopen som avgör *vad* som ska läsas, och en regression där hade lämnat samtliga deras siffror oförändrade.
